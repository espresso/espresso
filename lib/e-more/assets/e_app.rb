class EApp
  ...
  #
  # @note
  #   if second argument is true, Espresso will serve static files on given URL.
  #   if second argument is :sprockets [Symbol], Espresso will use Sprockets to serve your assets.
  #   in both cases make sure assets URL does not interfere with your actions.
  #
  # @example - assets not served, so no URL conflicts
  #
  # class App < E
  #   map '/'
  #
  ...
  #
  #
  # @example - assets served on same URL as controller, so controller WONT work
  #
  # class App < E
  #   map '/'
  #   
  ...
  # app.run
  #
  # @example - assets served on /assets URL
  #
  # class App < E
  #   map '/'
  #  
  ...
  # used when assets are served by Espresso.
